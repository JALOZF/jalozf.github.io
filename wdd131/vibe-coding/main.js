...
const cardList = [
    { id: 1, title: `Python Dictionaries`, tags: ['Python'], thumbnail: 'https://picsum.photos/400/300', description: `Python dictionaries are a powerful, built-in data structure that stores data as key-value pairs. They are unordered (in Python versions before 3.7) or insertion-ordered (Python 3.7+), mutable, and highly optimized for retrieving values quickly using their unique keys. They're commonly used to represent real- world entities, like a person's attributes (name: 'Alice', age: 30), or to map one set of data to another.` },

    { id: 2, title: `What's the deal with JavaScript?`, tags: ['HTML', 'JavaScript'], thumbnail: 'https://picsum.photos/200/300', description: `JavaScript (JS) is a versatile, high-level, interpreted programming language primarily known as the language of the web, running natively in all major web browsers to create interactive and dynamic content. Beyond front-end web development, its popular runtime environment, Node.js, allows it to be used for server-side programming, enabling full-stack development using a single language.` },

    { id: 3, title: `Everything is Clickable`, tags: ['HTML', 'CSS', 'JavaScript'], thumbnail: 'https://picsum.photos/300/300', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.' },

    { id: 4, title: `Making a Basic Game`, tags: ['Python'], thumbnail: 'https://picsum.photos/300/310', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.' }
]
